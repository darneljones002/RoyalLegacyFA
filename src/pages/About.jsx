...
// Optional: Thumbnail preview images (replace with real stills if available)
import testimonialThumb1 from '../assets/testimonial2-thumb.png';
import testimonialThumb2 from '../assets/testimonial1-thumb.png';
  ...
  return (
    <div className="bg-[#c5a468] text-[#000000] font-sans">
      ...
      <section className="py-10 px-6 text-center bg-[#c5a468]">
        ...
        />
        <h2 className="text-3xl sm:text-4xl font-bold mt-4 text-[#000000] inline-block border-b-4 border-[#f1d782] font-[Cinzel]">
      ...
      <section className="bg-[#f1d782] text-[#000000] py-12 px-6 mt-12 text-center">
        ...
        <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div
            ...
            onClick={() => openModal('/videos/testimonial1.mp4')}
          >
            <img
          ...
          <div
            className="relative cursor-pointer group"
            onClick={() => openModal('/videos/testimonial2.mp4')}
          >
            <img
